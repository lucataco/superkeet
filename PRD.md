...
| ENG-6 | The bundled engine version is pinned (currently parakeet-cli v0.1.10, protocol 2) in `install.sh`, the release workflow, and `DevelopmentEngineLocator`. | Shipped |
